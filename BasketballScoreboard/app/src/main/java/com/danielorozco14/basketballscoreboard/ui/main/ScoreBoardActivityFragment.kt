...
class ScoreBoardActivityFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_score_board_activity, container, false)
    }
    ...
    companion object {
         ...
         * @return A new instance of fragment ScoreBoardActivityFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            ScoreBoardActivityFragment().apply {
